    ...
    return (
        <section className="min-h-screen px-6 lg:px-12 py-32 max-w-[95rem] mx-auto grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] items-center gap-10 lg:gap-20">
            ...
            <motion.div
                ...
                className="w-full max-w-2xl mx-auto aspect-[3/4] relative hidden lg:block"
            >
                <TiltCard className="w-full h-full">
                    <div className="flex-1 relative w-full max-w-md lg:max-w-lg mx-auto">
                        {/* Responsive Image Container */}
                        <div className="relative aspect-[4/5] w-full rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl bg-white/5">
                            {siteConfig.heroImage ? (
                                <img
                                    src={siteConfig.heroImage}
                                    alt="Honore"
