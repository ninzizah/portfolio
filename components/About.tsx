            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                <div className="relative">
                    ...
                    <motion.h2
                        ...
                        className="text-5xl md:text-7xl font-black text-white tracking-tighter uppercase mb-12 leading-[0.9]"
                    >
                        The <br /> <span className="text-indigo-500">Architect.</span>
                    </motion.h2>
                    <div className="space-y-8 text-slate-400 text-lg md:text-xl leading-relaxed font-medium">
                ...
                <div className="grid grid-cols-2 gap-6">
                    <motion.div
                        ...
                        className="p-10 glass rounded-[3rem] border-white/5 text-center flex flex-col items-center justify-center gap-4"
                    >
